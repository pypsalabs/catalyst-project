...
% techno-economic baseline). Figures come from ../../misc-quarter1/technology-costs/figures/slides/, the
...
% ../../misc-quarter1/technology-costs/config.yaml
...
% how the archetypes were derived: the seven k-means features (../../misc-quarter1/country-classification/cluster_tsne.py) and
