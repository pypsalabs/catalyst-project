...
\begin{frame}{Project overview}
  ...
  \begin{textblock*}{\paperwidth}(0cm,5.65cm)
    \includegraphics[width=\paperwidth, height=2.15cm, trim=0 120px 0 110px, clip]{map_screenshot}
  \end{textblock*}
\end{frame}
...
\begin{frame}{The Initial Investment Mechanism}
  \centering
  \wideimage[10cm]{screenshots/investment_mechanism}
  \vspace{-0.2cm}
