...
% both partner logos on the title page, PyPSA Labs above Google
\titlegraphic{\includegraphics[height=1.5cm]{logo}\\[0.9cm]\includegraphics[height=0.8cm]{google_logo}}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\setlength{\itemsep}{0.25em}
        \item Quantifying the catalytic impact of early investment into advanced clean technologies:
          Experience curves, emission reduction, global addressable market
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Approach}
      \begin{itemize}\setlength{\itemsep}{0.25em}
        ...
        \item Measure the impact of early investment onto late, \textit{catalysed} runs
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{frame}{Endogenous learning in the world model (prototype)}
  \centering
